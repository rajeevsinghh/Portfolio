export const Bio = {
  name: "Rajeev Kumar",
  roles: ["Software Developer", "ReactJs Developer", "Programmer"],
  description:
  ...
  facebook: "https://m.facebook.com/profile.php/?id=100008122968375",
};
...
export const experiences = [
  {
    ...
    desc: "Designed and built the frontend of an online dress store, focusing on user-friendly interfaces and smooth navigation.",
    skills: [
      "Html",
      "Css",
      "javaScipt",
